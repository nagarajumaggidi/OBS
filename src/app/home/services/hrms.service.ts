...
deleteBusiness(buDeleteReqObj){
  ...
  return this.http.post("http://1192.168.7.41:8087/set",buDeleteReqObj);

  // return this.http.post("http://192.168.5.207:8087/set",buDeleteReqObj);

  // return this.http.post("http://192.168.7.41:8087/set",buDeleteReqObj);
...
getBusinessunit(businesinfo){
  ...
  return this.http.post("http://192.168.2.96:8087/get",businesinfo);
}
...
getempinfo(basicempinfo){
  ...
  return this.http.post("http://192.168.2.96:8093/get",basicempinfo);
...
saveempinfo(saveempobj){
  return this.http.post("http://192.168.2.96:8093/set",saveempobj);
}
deleteempinfo(deleteempobj){
  return this.http.post("http://192.168.2.96:8093/set",deleteempobj)
}
getbyIdempinfo(updateempobj){
  return this.http.post("http://192.168.2.96:8093/get",updateempobj);
}
updateempinfo(updateempinfoobj){
  return this.http.post("http://192.168.2.96:8093/set",updateempinfoobj);
}
